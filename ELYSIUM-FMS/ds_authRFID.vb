        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If cardNumber.Length > 0 Then
                If VerifyCardNumber(cardNumber) Then
                    ...
                    archived_form.Show()
                    archived_form.archive_pages.SetPage("direct_services")
                    Me.Close()
                Else
